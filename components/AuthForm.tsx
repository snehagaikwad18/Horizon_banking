  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (type === "sign-up") {
        ...
        // setUser(newUser);
        if (newUser) {
          console.log("newUser:", newUser); // Debugging log
          setUser(newUser);
        } else {
          console.log("Sign-up failed or newUser is null.");
        }
      }
      ...
      if (type === "sign-in") {
        ...
        console.log("Sign-in response:", response); // Check if response is valid
        if (response) {
          router.push("/");
        }
      }
